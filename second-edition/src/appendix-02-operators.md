...
| `"..."`                                         | 文字列リテラル|
| `r"..."`, `r#"..."#`, `r##"..."##`, *etc.*      | 生文字列リテラル、エスケープ文字は処理されません |
| `b"..."`                                        | バイト文字列リテラル、文字列の代わりに`[u8]`を構築します |
| `br"..."`, `br#"..."#`, `br##"..."##`, *etc.*   | 生バイト文字列リテラル、生文字列とバイト文字列の組み合わせ |
| `'...'`                                         | 文字リテラル |
| `b'...'`                                        | ASCIIバイトリテラル |
...
| `path::<...>`, `method::<...>` | 式中のジェネリックな型、関数、メソッドへの引数を指定する。しばしばturbofish(ターボ・フィッシュ)と称される。(*例*, `"42".parse::<i32>()`) |
